...
export type { FileStoreLike } from "./persistence/file-store";
export { collectSceneFiles, referencedFileIds } from "./persistence/file-store";
...
} from "./persistence/local-storage-autosave";
