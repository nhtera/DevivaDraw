...
export const catalogEn = {
  ...
  "action.togglePropertiesPanel": "Canvas & shape properties",
  "action.toggleToolLock": "Keep selected tool active",
  "zen.exit": "Exit zen mode",
  "menu.selectOn": "Select on",
  "selectOn.auto": "Auto",
  "selectOn.wrap": "Wrap",
  "selectOn.overlap": "Overlap",
  "action.cycleSelectOnMode": "Select on: Auto / Wrap / Overlap",
  "action.toggleArrowBinding": "Arrow binding",
  "action.toggleSnapMidpoints": "Snap to midpoints",
  "action.toggleConstantWidthPen": "Constant-width pen",
  ...
  "presentation.notesHint": "Presenter notes (N)",
  "presentation.react": "React with {emoji}",
  "presentation.raiseHand": "Raise hand",
  "presentation.raisedHands": "Hands up",
  "presentation.notesEmpty": "No notes for this slide.",
  "export.currentFrame": "Current frame only",
  ...
  "panel.italic": "Italic",
  "panel.layers": "Layer",
  "panel.frameNotes": "Presenter notes",
  "panel.frameNotesPlaceholder": "Notes shown only to you while presenting",
  ...
  "export.slidesNeedFrames": "Add a frame to export slides.",
  ...
  "share.dialog.qrLabel": "Scan to open on another device",
  ...
  "share.dialog.revokeFailedRateLimited": "Too many attempts — wait a minute and try again.",
  "share.dialog.idleHint": "Create a link to share a snapshot of this board, or manage links you've already shared below.",
  "share.dialog.generate": "Create link",
  ...
  "layers.moveSelectionHere": "Move selection to this layer",
  ...
  "action.toggleComments": "Comments panel",

  "versionHistory.close": "Close",
  "versionHistory.title": "Version history",
  "versionHistory.description": "Snapshots of this board, taken automatically as you work.",
  "versionHistory.empty": "No versions yet — one is saved automatically a few minutes into editing.",
  "versionHistory.loading": "Reading history…",
  "versionHistory.unavailable": "Version history is off — this browser is not letting the app store data.",
  "versionHistory.stopped": "Storage is full, so no new versions are being saved. Delete some to start again.",
  "versionHistory.save": "Save version…",
  "versionHistory.saveLabelPrompt": "Name this version",
  "versionHistory.saveLabelPlaceholder": "e.g. before the redesign",
  "versionHistory.restore": "Restore",
  "versionHistory.restoreBlocked": "You cannot restore a version while a collaboration session is connected — everyone in the room shares this board.",
  "versionHistory.restoreConfirm": "Restore this version? It replaces all {pages} page(s) of the open board. The current board is saved first, so you can come back.",
  "versionHistory.restoreFailed": "That version could not be restored — it may have been deleted, or its data is damaged. Nothing on the board has changed.",
  "versionHistory.delete": "Delete this version",
  "versionHistory.clear": "Clear history",
  "versionHistory.clearConfirm": "Delete every saved version of this board? This cannot be undone.",
  "versionHistory.preview": "Preview",
  "versionHistory.previewUnavailable": "No preview",
  "versionHistory.pages": "{count} page(s)",
  "versionHistory.elements": "{count} item(s)",
  "versionHistory.trigger.auto": "Automatic",
  "versionHistory.trigger.manual": "Saved by you",
  "versionHistory.reason.before-open": "Before opening a file",
  "versionHistory.reason.before-clear": "Before clearing the canvas",
  "versionHistory.reason.before-join": "Before joining a room",
  "versionHistory.reason.before-restore": "Before restoring a version",
  "action.toggleVersionHistory": "Version history",

  "comments.commentingAs": "Commenting as",
  "comments.title": "Comments",
  "comments.thread": "Comment",
  "comments.resolvedThread": "Resolved",
  "comments.resolve": "Resolve",
  "comments.unresolve": "Reopen",
  "comments.deleteThread": "Delete thread",
  "comments.deleteMessage": "Delete comment",
  "comments.close": "Close",
  "comments.empty": "No comments yet",
  "comments.none": "No comments on this page",
  "comments.showResolved": "Show resolved",
  "comments.composerPlaceholder": "Write a comment…",
  "comments.readOnlyHint": "Open the board to reply.",
  ...
  "collab.dialog.qrLabel": "Scan to join this session",
  "collab.dialog.leave": "Leave session",
  "collab.dialog.peersLabel": "{count} online",
  "collab.dialog.editorLink": "Editor link",
  "collab.dialog.viewerLink": "Viewer link",
  "collab.dialog.linksHint": "Anyone with the editor link can draw. The viewer link joins read-only — the server itself rejects a viewer's edits, so the limit holds even against a tampered-with client.",
  "collab.follow.follow": "Follow",
  "collab.follow.stop": "Stop following",
  "collab.follow.following": "Following {name}",
  "collab.role.viewer": "Viewing only",
  "collab.role.viewerHint": "You joined with a viewer link. You can watch and follow along, but not edit.",
  "collab.host.title": "Host on this network",
  "collab.host.description": "Run the session on this computer instead of a server. No internet needed \u2014 people on the same network draw together directly.",
  "collab.host.addressLabel": "Network",
  "collab.host.portLabel": "Port",
  "collab.host.start": "Start hosting",
  "collab.host.starting": "Starting\u2026",
  "collab.host.stop": "Stop hosting",
  "collab.host.hosting": "This room is hosted on your computer.",
  "collab.host.desktopOnly": "Others join from the Deviva Draw desktop app \u2014 a web browser can\u2019t join a local-network room.",
  "collab.host.error.alreadyHosting": "You\u2019re already hosting a room.",
  "collab.host.error.portInUse": "That port is already in use on this computer.",
  "collab.host.error.permissionDenied": "This computer blocked the connection. Allow local network access for Deviva Draw in your system settings, then try again.",
  "collab.host.error.noNetwork": "This computer isn\u2019t on a local network, so there\u2019s nothing for anyone to join.",
  "collab.host.error.startFailed": "Couldn\u2019t start hosting. Please try again.",
  "collab.ended.hostStopped": "The host stopped the session. Anything you draw now stays on this device.",
  "collab.ended.refused": "The session refused this connection. Ask for a new link.",
  "collab.ended.unreachable": "Lost the session and couldn\u2019t get back to it. Anything you draw now stays on this device.",
