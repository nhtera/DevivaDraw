...
export const catalogEn = {
  ...
  "collab.dialog.linksHint": "Anyone with the editor link can draw. The viewer link joins read-only — a viewer can watch and comment, and the server rejects their edits.",
  ...
  "collab.role.viewerHint": "You joined with a viewer link. You can comment, but not edit.",
