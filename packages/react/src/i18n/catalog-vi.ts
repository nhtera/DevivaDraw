...
export const catalogVi: Record<TranslationKey, string> = {
  ...
  "collab.dialog.linksHint": "Ai có liên kết chỉnh sửa đều có thể vẽ. Liên kết chỉ xem tham gia ở chế độ chỉ đọc — người xem có thể theo dõi và bình luận, còn máy chủ sẽ từ chối các chỉnh sửa của họ.",
  ...
  "collab.role.viewerHint": "Bạn đã tham gia bằng liên kết chỉ xem. Bạn có thể bình luận nhưng không thể chỉnh sửa.",
