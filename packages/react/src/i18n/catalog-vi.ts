...
export const catalogVi: Record<TranslationKey, string> = {
  ...
  "action.togglePropertiesPanel": "Thuộc tính canvas & hình",
  "action.toggleToolLock": "Giữ công cụ đang chọn",
  "zen.exit": "Thoát chế độ tập trung",
  "menu.selectOn": "Chọn khi",
  "selectOn.auto": "Tự động",
  "selectOn.wrap": "Bao trọn",
  "selectOn.overlap": "Chạm vào",
  "action.cycleSelectOnMode": "Chọn khi: Tự động / Bao trọn / Chạm vào",
  "action.toggleArrowBinding": "Kết nối mũi tên",
  "action.toggleSnapMidpoints": "Bám vào điểm giữa cạnh",
  "action.toggleConstantWidthPen": "Bút nét đều",
  "action.present": "Trình chiếu",
  "presentation.next": "Trang sau",
  "presentation.previous": "Trang trước",
  "presentation.exit": "Thoát trình chiếu",
  "presentation.notes": "Ghi chú người trình bày",
  "presentation.notesHint": "Ghi chú người trình bày (N)",
  "presentation.react": "Bày tỏ cảm xúc {emoji}",
  "presentation.raiseHand": "Giơ tay",
  "presentation.raisedHands": "Đang giơ tay",
  "presentation.notesEmpty": "Trang này chưa có ghi chú.",
  "export.currentFrame": "Chỉ khung hiện tại",
  ...
  "panel.layers": "Lớp",
  "panel.frameNotes": "Ghi chú người trình bày",
  "panel.frameNotesPlaceholder": "Ghi chú chỉ hiện với bạn khi trình chiếu",
  ...
  "export.slides": "Trang chiếu",
  "export.slidesNeedFrames": "Thêm khung để xuất trang chiếu.",
  ...
  "share.dialog.qrLabel": "Quét để mở trên thiết bị khác",
  ...
  "action.toggleComments": "Bảng bình luận",

  "versionHistory.close": "Đóng",
  "versionHistory.title": "Lịch sử phiên bản",
  "versionHistory.description": "Các bản chụp của bảng vẽ này, được lưu tự động khi bạn làm việc.",
  "versionHistory.empty": "Chưa có phiên bản nào — một bản sẽ được lưu tự động sau vài phút chỉnh sửa.",
  "versionHistory.loading": "Đang đọc lịch sử…",
  "versionHistory.unavailable": "Lịch sử phiên bản đang tắt — trình duyệt này không cho phép ứng dụng lưu dữ liệu.",
  "versionHistory.stopped": "Bộ nhớ đã đầy nên không lưu thêm phiên bản mới. Hãy xóa bớt để tiếp tục.",
  "versionHistory.save": "Lưu phiên bản…",
  "versionHistory.saveLabelPrompt": "Đặt tên cho phiên bản này",
  "versionHistory.saveLabelPlaceholder": "ví dụ: trước khi thiết kế lại",
  "versionHistory.restore": "Khôi phục",
  "versionHistory.restoreBlocked": "Không thể khôi phục phiên bản khi phiên cộng tác đang kết nối — mọi người trong phòng dùng chung bảng vẽ này.",
  "versionHistory.restoreConfirm": "Khôi phục phiên bản này? Thao tác này thay thế toàn bộ {pages} trang của bảng vẽ đang mở. Bảng vẽ hiện tại được lưu trước, nên bạn có thể quay lại.",
  "versionHistory.restoreFailed": "Không thể khôi phục phiên bản đó — có thể nó đã bị xóa hoặc dữ liệu bị hỏng. Bảng vẽ không thay đổi gì.",
  "versionHistory.delete": "Xóa phiên bản này",
  "versionHistory.clear": "Xóa lịch sử",
  "versionHistory.clearConfirm": "Xóa mọi phiên bản đã lưu của bảng vẽ này? Thao tác này không thể hoàn tác.",
  "versionHistory.preview": "Xem trước",
  "versionHistory.previewUnavailable": "Không có bản xem trước",
  "versionHistory.pages": "{count} trang",
  "versionHistory.elements": "{count} đối tượng",
  "versionHistory.trigger.auto": "Tự động",
  "versionHistory.trigger.manual": "Bạn đã lưu",
  "versionHistory.reason.before-open": "Trước khi mở tệp",
  "versionHistory.reason.before-clear": "Trước khi xóa bảng vẽ",
  "versionHistory.reason.before-join": "Trước khi vào phòng",
  "versionHistory.reason.before-restore": "Trước khi khôi phục phiên bản",
  "action.toggleVersionHistory": "Lịch sử phiên bản",

  "comments.commentingAs": "Bình luận với tên",
  "comments.title": "Bình luận",
  "comments.thread": "Bình luận",
  "comments.resolvedThread": "Đã giải quyết",
  "comments.resolve": "Đánh dấu đã giải quyết",
  "comments.unresolve": "Mở lại",
  "comments.deleteThread": "Xóa chuỗi bình luận",
  "comments.deleteMessage": "Xóa bình luận",
  "comments.close": "Đóng",
  "comments.empty": "Chưa có bình luận",
  "comments.none": "Trang này chưa có bình luận",
  "comments.showResolved": "Hiện mục đã giải quyết",
  "comments.composerPlaceholder": "Viết bình luận…",
  "comments.readOnlyHint": "Mở bảng vẽ để trả lời.",
  ...
  "collab.dialog.qrLabel": "Quét để tham gia phiên này",
  "collab.dialog.leave": "Rời phiên",
  "collab.dialog.peersLabel": "{count} đang trực tuyến",
  "collab.dialog.editorLink": "Liên kết chỉnh sửa",
  "collab.dialog.viewerLink": "Liên kết chỉ xem",
  "collab.dialog.linksHint": "Ai có liên kết chỉnh sửa đều có thể vẽ. Liên kết chỉ xem tham gia ở chế độ chỉ đọc — chính máy chủ từ chối các chỉnh sửa của người xem, nên giới hạn này vẫn giữ nguyên kể cả khi ứng dụng bị can thiệp.",
  "collab.follow.follow": "Theo dõi",
  "collab.follow.stop": "Ngừng theo dõi",
  "collab.follow.following": "Đang theo dõi {name}",
  "collab.role.viewer": "Chỉ xem",
  "collab.role.viewerHint": "Bạn đã tham gia bằng liên kết chỉ xem. Bạn có thể theo dõi nhưng không thể chỉnh sửa.",
  "collab.host.title": "Ph\u00e1t tr\u00ean m\u1ea1ng n\u1ed9i b\u1ed9",
  "collab.host.description": "Ch\u1ea1y phi\u00ean ngay tr\u00ean m\u00e1y n\u00e0y thay v\u00ec qua m\u00e1y ch\u1ee7. Kh\u00f4ng c\u1ea7n Internet \u2014 m\u1ecdi ng\u01b0\u1eddi c\u00f9ng m\u1ea1ng v\u1ebd chung tr\u1ef1c ti\u1ebfp.",
  "collab.host.addressLabel": "M\u1ea1ng",
  "collab.host.portLabel": "C\u1ed5ng",
  "collab.host.start": "B\u1eaft \u0111\u1ea7u ph\u00e1t",
  "collab.host.starting": "\u0110ang b\u1eaft \u0111\u1ea7u\u2026",
  "collab.host.stop": "D\u1eebng ph\u00e1t",
  "collab.host.hosting": "Ph\u00f2ng n\u00e0y \u0111ang \u0111\u01b0\u1ee3c ph\u00e1t t\u1eeb m\u00e1y c\u1ee7a b\u1ea1n.",
  "collab.host.desktopOnly": "Ng\u01b0\u1eddi kh\u00e1c tham gia b\u1eb1ng \u1ee9ng d\u1ee5ng m\u00e1y t\u00ednh Deviva Draw \u2014 tr\u00ecnh duy\u1ec7t web kh\u00f4ng v\u00e0o \u0111\u01b0\u1ee3c ph\u00f2ng m\u1ea1ng n\u1ed9i b\u1ed9.",
  "collab.host.error.alreadyHosting": "B\u1ea1n \u0111ang ph\u00e1t m\u1ed9t ph\u00f2ng r\u1ed3i.",
  "collab.host.error.portInUse": "C\u1ed5ng \u0111\u00f3 \u0111ang \u0111\u01b0\u1ee3c d\u00f9ng tr\u00ean m\u00e1y n\u00e0y.",
  "collab.host.error.permissionDenied": "M\u00e1y n\u00e0y \u0111\u00e3 ch\u1eb7n k\u1ebft n\u1ed1i. H\u00e3y cho ph\u00e9p Deviva Draw truy c\u1eadp m\u1ea1ng n\u1ed9i b\u1ed9 trong c\u00e0i \u0111\u1eb7t h\u1ec7 th\u1ed1ng r\u1ed3i th\u1eed l\u1ea1i.",
  "collab.host.error.noNetwork": "M\u00e1y n\u00e0y kh\u00f4ng \u1edf trong m\u1ea1ng n\u1ed9i b\u1ed9 n\u00e0o n\u00ean kh\u00f4ng ai tham gia \u0111\u01b0\u1ee3c.",
  "collab.host.error.startFailed": "Kh\u00f4ng th\u1ec3 b\u1eaft \u0111\u1ea7u ph\u00e1t. Vui l\u00f2ng th\u1eed l\u1ea1i.",
  "collab.ended.hostStopped": "Ng\u01b0\u1eddi ch\u1ee7 \u0111\u00e3 d\u1eebng phi\u00ean. M\u1ecdi th\u1ee9 b\u1ea1n v\u1ebd t\u1eeb gi\u1edd ch\u1ec9 n\u1eb1m tr\u00ean m\u00e1y n\u00e0y.",
  "collab.ended.refused": "Phi\u00ean \u0111\u00e3 t\u1eeb ch\u1ed1i k\u1ebft n\u1ed1i n\u00e0y. H\u00e3y xin m\u1ed9t li\u00ean k\u1ebft m\u1edbi.",
  "collab.ended.unreachable": "M\u1ea5t k\u1ebft n\u1ed1i v\u00e0 kh\u00f4ng quay l\u1ea1i \u0111\u01b0\u1ee3c phi\u00ean. M\u1ecdi th\u1ee9 b\u1ea1n v\u1ebd t\u1eeb gi\u1edd ch\u1ec9 n\u1eb1m tr\u00ean m\u00e1y n\u00e0y.",
